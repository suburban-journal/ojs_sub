<?php return array (
  ...
  'manager.announcements.noneCreated' => 'Keine Mitteilungen erstellt',
  ...
  'manager.emails.addEmail' => 'E-Mail-Vorlage hinzufügen',
  ...
  'manager.emails.resetAll' => 'Alle Vorlagen zurücksetzen',
  ...
  'manager.people.emailUsers.selectUsers' => 'Wählen Sie die Benutzer/innen, denen Sie eine E-Mail senden wollen, dadurch aus, dass Sie die Kästchen neben ihren Namen anklicken.',
  ...
  'manager.setup.additionalContentDescription' => 'Alle hier eingegebenen Inhalte werden auf Ihrer Homepage erscheinen.',
  'manager.setup.authorCopyrightNotice' => 'Copyright-Vermerk',
  'manager.setup.authorCopyrightNoticeAgree' => 'Autor/innen müssen im Einreichungsverfahren der Lizenz zustimmen.',
  ...
  'manager.setup.competingInterestsDescription' => 'Gutachter/innen werden aufgefordert, den Richtlinien zur Offenlegung von Interessenkonflikten zu entsprechen, die Sie unten angeben.',
  'manager.setup.errorDeletingItem' => 'Es gab einen Fehler beim Löschen dieses Eintrags.',
  'manager.setup.favicon' => 'Ungültiges Favicon-Format. Zulässige Formate sind .ico, .png und .gif.',
  'manager.setup.groupType' => 'Dateitypgruppierung',
  'manager.setup.homeHeaderImageInvalid' => 'Das Format des Logos in der Kopfzeile der Startseite ist ungültig. Gültige Formate sind .gif, .jpg und .png.',
  'manager.setup.homepageImage' => 'Startseitengrafik',
  'manager.setup.homepageImageDescription' => 'Laden Sie eine Grafik hoch, die zentral auf Ihrer Homepage angezeigt werden soll.',
  ...
  'manager.setup.layout.theme' => 'Grafisches Thema',
  'manager.setup.layout.themeDescription' => 'Wählen Sie ein Grafikthema aus den verfügbaren Thema-Plugins aus.',
  'manager.setup.layout.blockManagement' => 'Verwaltung der Sidebar',
  'manager.setup.layout.sidebar' => 'Sidebar',
  'manager.setup.layout.unselected' => 'Nicht ausgewählt',
  ...
  'manager.setup.pageFooterDescription' => 'Geben Sie alle Grafiken, Text oder HTML-Code an, die Sie am Fuß Ihrer Website anzeigen möchten.',
  ...
  'manager.setup.reviewOptions.remindForInvite' => 'Eine Erinnerung schicken, wenn ein/e Gutachter/in auf die Anfrage nicht innerhalb der genannten Zeit geantwortet hat (Tage):',
  'manager.setup.reviewOptions.remindForSubmit' => 'Eine Erinnerung schicken, wenn ein/e Gutachter/in nicht innerhalb der genannten Zeit eine Empfehlung eingereicht hat (Tage):',
  'manager.setup.reviewOptions.reviewTime' => 'Standard-Fristen für Begutachtung',
  'manager.setup.reviewOptions.showBlindReviewLink' => 'Einen Link zu "blinde Begutachtung gewährleisten" während des Uploads anzeigen',
  'manager.setup.searchEngineIndexing.sitemap' => 'Sitemap',
  'manager.setup.searchEngineIndexing.sitemapDescription' => 'Eine XML-Sitemap zur Übermittlung an Suchmaschinen steht unter <a href="{$path}" target="_blank">{$path}</a> zur Verfügung.',
  'manager.setup.sponsors.note' => 'Sie können einen Hinweis hinzufügen, wie Ihr Verhältnis zu Ihren Sponsoren ist; dieser Hinweis wird in der Sponsorenliste auf Ihrer "Über uns"-Seite erscheinen.',
  ...
  'manager.plugins.copyError' => 'Das Plugin wurde nicht erfolgreich kopiert',
  ...
  'manager.distribution.indexing' => 'Indizierung',
  ...
  'manager.paymentMethod.currency.description' => 'Zahlungen, die direkt über diese Website abgewickelt werden, werden in der ausgewählten Währung ausgewiesen.',
  ...
  'manager.setup.reviewerCompetingInterestsRequired.description' => 'Erklärung von Gutachter/in zu möglicherweise bestehenden Interessenkonflikten',
