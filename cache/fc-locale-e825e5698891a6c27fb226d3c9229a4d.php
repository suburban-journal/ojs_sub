<?php return array (
  ...
  'manager.language.confirmDefaultSettingsOverwrite' => 'Dies wird alle Einstellungen, die Sie für diese Regionaleinstellung gewählt hatten, ersetzen.',
  ...
  'manager.payment.currency' => 'Währung',
  ...
  'manager.sections.abstractsNotRequired' => 'Benötigt keine Abstracts.',
  ...
  'manager.sections.wordCountInstructions' => 'Wortanzahl für Abstracts für diese Rubrik begrenzen (0 für keine Begrenzung):',
  'manager.setup' => 'Setup',
  'manager.setup.masthead' => 'Impressum',
  'manager.setup.editorialTeam' => 'Redaktion',
  'manager.setup.editorialTeam.description' => 'Nennen Sie Redakteur/innen, Verwalter/innen und andere mit der Zeitschrift verbundene Personen.',
  ...
  'manager.setup.layout' => 'Layout der Zeitschrift',
  ...
  'manager.setup.announcementsDescription' => 'Sie können die Leser/innen über die Zeitschrift betreffende Neuigkeiten und Ereignisse auf der Mitteilungsseite der Zeitschrift informieren.',
  'manager.setup.announcementsIntroductionDescription' => 'Geben Sie zusätzliche Informationen ein, die den Leser/innen auf der Mitteilungsseite angezeigt werden.',
  ...
  'manager.setup.copyeditInstructions' => 'Anweisungen für das Lektorat',
  'manager.setup.copyeditInstructionsDescription' => 'Die Anweisungen werden den Lektor/innen, Autor/innen und Redakteur/innen mit dem zu bearbeitenden Beitrag übermittelt. Nachstehend finden Sie eine Reihe von Standardanweisungen im HTML-Format. Sie können jederzeit von der Zeitschriftenverwaltung ersetzt oder geändert werden (in HTML oder einfachem Text).',
  'manager.setup.copyrightNotice' => 'Copyright-Vermerk',
  'manager.setup.coverage' => 'Themenbereich',
  'manager.setup.coverageDescription' => 'Bezieht sich auf den räumlich-geografischen, auf den zeitlichen Bereich und auf die Eigenschaften des Fachgebiets.',
  ...
  'manager.setup.emailBounceAddressDescription' => 'Jede E-Mail, die nicht zugestellt werden kann, erzeugt eine Fehlermeldung, die an diese Adresse geschickt wird.',
  'manager.setup.emailBounceAddressDisabled' => '<strong>Anmerkung:</strong> Die Website-Administrator/in muss in der OJS-Konfigurationsdatei die Option <tt>allow_envelope_sender</tt> aktivieren, um dies zu ermöglichen. Weitere Servereinstellungen können erforderlich sein (und sind nicht unbedingt auf allen Servern verfügbar). Siehe OJS-Dokumentation.',
  'manager.setup.emails' => 'E-Mail-Kennzeichnung',
  'manager.setup.emailSignatureDescription' => 'Alle E-Mail-Vorlagen, die vom System im Namen der Zeitschrift verschickt werden, tragen die folgende Signatur. Die E-Mail-Vorlagen können unter "Zeitschriftenverwaltung" bearbeitet werden.',
  'manager.setup.emailSignature' => 'Signatur',
  'manager.setup.enableAnnouncements' => 'Erlauben Sie den Zeitschriftenverwalter/innen, Mitteilungen hinzuzufügen.',
  'manager.setup.enableAnnouncementsHomepage1' => 'Anzeige der',
  'manager.setup.enableAnnouncementsHomepage2' => 'neuesten Mitteilungen auf der Startseite der Zeitschrift',
  ...
  'manager.setup.form.supportNameRequired' => 'Der Name des Kontakts bei technischen Fragen ist erforderlich',
  ...
  'manager.setup.journalSummary' => 'Zusammenfassung der Zeitschrift',
  'manager.setup.journalSummary.description' => 'Eine kurze Beschreibung Ihrer Zeitschrift, die in der Liste der Zeitschriften angezeigt werden kann.',
  'manager.setup.journalAbout' => 'Über uns',
  'manager.setup.journalAbout.description' => 'Nehmen Sie alle Informationen über Ihre Zeitschrift mit auf, die von Interesse für Leser/innen, Autor/innen oder Gutachter/innen sein könnten. Hierzu könnten Ihre Open-Access-Policy, das Konzept Ihrer Zeitschrift, Copyright-Angaben, Informationen über Sponsoren, die Geschichte der Zeitschrift, Angaben zum Datenschutz und die Beteiligung an LOCKSS- oder CLOCKSS-Archivierungssystemen gehören.',
  'manager.setup.favicon' => 'Favicon der Zeitschrift',
  'manager.setup.faviconDescription' => 'Fügen Sie ein Favicon für diese Zeitschrift hinzu, das in der Navigationsleiste angezeigt werden kann, wenn Nutzer/innen Ihre Website besuchen.',
  'manager.setup.faviconInvalid' => 'Ungültiges Favicon-Format. Zulässige Formate sind .ico, .png und .gif.',
  ...
  'manager.setup.journalInitials' => 'Kürzel der Zeitschrift',
  ...
  'manager.setup.journalThumbnail.altText' => 'Alternativtext für Thumbnail',
  'manager.setup.journalTitle' => 'Titel der Zeitschrift',
  'manager.setup.labelName' => 'Seitenbenennung',
  'manager.setup.layoutInstructions' => 'Anweisungen für das Layout',
  'manager.setup.layoutInstructionsDescription' => 'Anweisungen für die Formatierung zu veröffentlichender Beiträge können nachfolgend in HTML oder einfachem Text eingegeben werden. Sie werden den Layouter/innen und Rubrikredakteur/innen auf der Redaktionsseite jedes Beitrags zur Verfügung gestellt. (Da jede Zeitschrift ihre eigenen Layoutstrukturen, Formate, bibliografischen Standards, Style Sheets usw. haben kann, sind hier keine Standardanweisungen vorgesehen.)',
  'manager.setup.layoutTemplates' => 'Layoutvorlagen',
  'manager.setup.layoutTemplatesDescription' => 'Layoutvorlagen für alle Standardformate der Zeitschrift (z.B. Beiträge, Rezensionen usw.) können hochgeladen und unter "Layout" abgerufen werden, wobei alle Dateiformate (z.B. pdf, doc usw.) benutzt werden können. Anmerkungen zu Zeichensatz, Schriftgröße, Rand etc. erleichtern Layouter/innen und Korrekturlektor/innen die Arbeit.',
  'manager.setup.layoutTemplates.file' => 'Vorlagendatei',
  'manager.setup.layoutTemplates.title' => 'Titel',
  'manager.setup.lists' => 'Listen',
  'manager.setup.listsDescription' => 'Maximalzahl der Elemente auf jeder Listenseite (z.B. Beiträge, Benutzer/innen oder redaktionelle Aufgaben) festlegen sowie die Anzahl der Links, die auf jeder Seite erscheinen sollen.',
  'manager.setup.enableArchive' => 'Archivierung aktivieren',
  ...
  'manager.setup.lockssEnable' => 'Aktivieren Sie LOCKSS und speichern und verteilen Sie den Inhalt der Zeitschrift bei den an LOCKSS teilnehmenden Bibliotheken über ein <a href="{$lockssUrl}" target="_blank">LOCKSS-Manifest</a>. Es erscheint dann eine Lizenz von LOCKSS im "Über uns" der Zeitschrift unter "Archiv":',
  ...
  'manager.setup.porticoEnable' => 'Portico ermöglichen, Zeitschrifteninhalte zu archivieren und an teilnehmende Bibliotheken auszuliefern.',
  ...
  'manager.setup.onlineAccessManagement' => 'Zugang zum Zeitschrifteninhalt',
  'manager.setup.onlineIssn' => 'ISSN Internet',
  'manager.setup.openAccess' => 'Die Zeitschrift bietet freien Zugang (Open Access) zu ihren Inhalten.',
  ...
  'manager.setup.provideRefLinkInstructions' => 'Layouter/innen Anweisungen geben',
  ...
  'manager.setup.publisherDescription' => 'Der Name der Organisation, die die Zeitschrift herausgibt, erscheint unter "Über uns".',
  'manager.setup.referenceLinking' => 'Verlinkung von Literaturverweisen',
  'manager.setup.refLinkInstructions.description' => 'Layout-Anweisungen für das Verlinken von Literaturverweisen',
  ...
  'manager.setup.reviewOptions.restrictReviewerFileAccess' => 'Erst wenn Sie der Übernahme der Begutachtung zugestimmt haben, erhalten Gutachter/innen Zugriff auf die jeweilige Beitragsdatei.',
  'manager.setup.reviewOptions.reviewerAccess' => 'Zugang für Gutachter/innen',
  'manager.setup.reviewOptions.reviewerAccessKeysEnabled' => 'One-Click-Zugang für Gutachter/innen aktiviert.',
  ...
  'manager.setup.searchEngineIndexingDescription' => 'Damit die Nutzer/innen von Suchmaschinen die Zeitschrift einfacher finden, stellen Sie bitte eine kurze Beschreibung der Zeitschrift und charakteristische Schlagworte (durch Semikolon getrennt) zusammen.',
  ...
  'manager.setup.securitySettings' => 'Zugangs- und Sicherheitseinstellungen',
  'manager.setup.securitySettingsDescription' => 'OJS bietet eine Reihe von sicherheitsrelevanten Optionen, mit denen die Inhalte der Zeitschrift beschränkt werden können oder die zusätzliche Informationen über Beiträge für Kontrollzwecke liefern.',
  ...
  'manager.setup.siteAccess' => 'Zusätzliche Beschränkungen des Zugriffs auf Seiten und Artikel',
  ...
  'manager.setup.subscription' => 'Einige oder alle Inhalte der Zeitschrift sind nur für Abonnent/innen zugänglich.',
  'manager.setup.subscriptionDescription' => 'Die Einrichtung der Funktion einer Abonnementverwaltung ist in diesem Fall nötig. Diese hat Zugang zu den Abonnement-Modulen, was auch frei zugängliche Angebote, Selbst-Archivierung und Benachrichtigungen per E-Mail beinhaltet.',
  'manager.setup.noPublishing' => 'OJS wird nicht verwendet, um die Zeitschrifteninhalte online zu veröffentlichen.',
  ...
  'manager.setup.useJournalStyleSheet' => 'Style Sheet für die Zeitschrift',
  ...
  'manager.subscriptionPolicies.authorSelfArchive' => 'Richtlinien zur Selbstarchivierung durch die/den Autor/in',
  'manager.subscriptionPolicies.authorSelfArchiveDescription' => 'Die folgenden Richtlinien zur Selbstarchivierung durch die/den Autor/in erscheinen im "Über uns" unter "Zur Zeitschrift"',
  'manager.subscriptionPolicies.delayedOpenAccess' => 'Verzögerter Open Access',
  'manager.subscriptionPolicies.delayedOpenAccessDescription' => 'Auch bei verzögertem Open Access können Redakteur/innen einzelne Beiträge unmittelbar frei zugänglich machen.',
  'manager.subscriptionPolicies.delayedOpenAccessDescription1' => 'Die zurückliegenden Ausgaben der Zeitschrift sind',
  'manager.subscriptionPolicies.delayedOpenAccessDescription2' => 'Monat(e) nach Erscheinen frei zugänglich',
  'manager.subscriptionPolicies.delayedOpenAccessDurationValid' => 'Bitte wählen Sie eine gültige Frist.',
  'manager.subscriptionPolicies.delayedOpenAccessPolicyDescription' => 'Die folgenden Richtlinien zu verzögertem Open Access erscheinen im "Über uns" unter "Zur Zeitschrift".',
  ...
  'manager.subscriptionPolicies.numMonthsAfterSubscriptionExpiryReminderValid' => 'Bitte eine gültige Zahl vor "Monat(e) nach Ablauf des Abonnements" eintragen',
  ...
  'manager.subscriptionTypes.form.institutional' => 'Abonnent/innen sollten über eine Domain oder einen IP-Bereich identifizierbar sein.',
  'manager.subscriptionTypes.form.institutionalValid' => 'Bitte im Kästchen ankreuzen.',
  'manager.subscriptionTypes.form.membership' => 'Abonnent/innen müssen Mitglieder eines Verbands oder einer Organisation sein.',
  ...
  'manager.setup.resetPermissions.confirm' => 'Sind Sie sicher, dass Sie die Rechte, die bisher den Artikeln zugewiesen sind, zurücksetzen möchten?',
  'manager.setup.resetPermissions.description' => 'Copyright-Angaben und Lizenzinformationen werden permanent mit veröffentlichten Inhalten verknüpft. Damit wird sichergestellt, dass diese Angaben nicht geändert werden, wenn eine Zeitschrift ihre Policy für neue Einreichungen ändert. Nutzen Sie den Knopf unten, um gespeicherte Rechteinformationen, die bereits mit veröffentlichten Inhalten verknüpft sind, zurückzusetzen.',
