<?php return array (
  ...
  'submission.indexing' => 'Indizieren',
  'submission.initiated' => 'Begonnen',
  'submission.identifiers' => 'Identifier',
  'submission.publisherId' => 'Öffentliche URL',
  ...
  'submissions.queuedUnassigned' => 'Noch nicht zugewiesen',
  ...
  'submission.submit.form.agenciesRequired' => 'Bitte geben Sie eine unterstützende Organisation ein.',
  ...
  'submission.form.name' => 'Bitte geben Sie dieser Datei einen aussagefähigen Namen.',
  ...
  'submission.event.fileAuditUploaded' => '"{$name}" ({$username}) hat eine Prüfung abgeschlossen und "{$file}" hochgeladen.',
  ...
  'submission.list.count' => '{$count} Einreichungen',
  'submission.list.itemsOfTotal' => '{$count} von {$total} Einreichungen',
  ...
  'submission.list.itemOrdererUp' => 'Position von {$itemTitle} nach oben setzen',
  'submission.list.itemOrdererDown' => 'Position von {$itemTitle} nach unten setzen',
