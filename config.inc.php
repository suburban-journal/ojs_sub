...
base_url = "http://zeitschrift-suburban.de/sys"
...
; Examples:
; base_url[index] = https://zeitschrift-suburban.de/sys/index.php/index
; base_url[suburban] = https://zeitschrift-suburban.de/sys/index.php/suburban
...
driver = mysqli
host = localhost
username = suburban_user5
password = Wxd7Y4PRn9pv8Bswm2DE
name = suburban_5
...
; files_dir = files
files_dir = /home/suburban/public_html/ojs-files
...
; stripped.
; allowed_html=a[href|target|title],em,strong,cite,code,ul,ol,li[class],dl,dt,dd,b,i,u,img[src|alt|style|width|height],sup,sub,br,p,align,height, style, float"
allowed_html = "a[href|target|title],em,strong,cite,code,br,ul,ol,li[class],dl,dt,dd,b,i,u,img[src|alt|style|border|width|height|margin-right|align],sup,sub,br,p,align,height, style, float, border"
...
default_envelope_sender = admin@zeitschrift-suburban.de
...
repository_id = ojs.www.zeitschrift-suburban.de
