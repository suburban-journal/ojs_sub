...
<div id="main-content" class="page page_submissions">
	...
	{if $submissionChecklist}
		<div class="submission_checklist">
			<div class="page-header">
				<h2>
					{translate key="about.submissionPreparationChecklist"}	</h2>
			...
			<p class="lead description">
					<h4>{translate key="about.submissionPreparationChecklist.description"}
				</h4></p>
			<ul class="list-group">
	...
	{if $currentJournal->getLocalizedSetting('authorGuidelines')}
		<div class="author_guidelines">
			<h2 class="page-header">
				{translate key="about.authorGuidelines"}</h2>
